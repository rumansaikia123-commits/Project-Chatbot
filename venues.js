...
// rating/costForTwo are real fields (not embedded in prose) so structured
// output can show a clean star rating and price on each card, same as
// restaurants.js. rating is nullable — several venues never had a star
// rating in the original source, and it's more honest to say so than to
// invent one. Field named "highlight" (not "notes") to match
// restaurants.js's naming, since both files describe the same kind of thing.
const venues = [
  // ----- Live music -----
  { name: 'The Maroon Room', area: 'Dispur', tags: ['live-music'],
    rating: 4.9, costForTwo: null,
    highlight: "Guwahati's only restaurant with live entertainment every night (Karaoke Fridays, Live Band Sat/Sun, DJ Kangkan Thursdays). Also an art gallery, ranked #2 in the city." },
  { name: 'The Anglers (Club & Tavern)', area: 'Uzan Bazar, 62 Bhuban Road', tags: ['live-music'],
    rating: 4.8, costForTwo: null,
    highlight: 'Irish-pub-inspired. Live music Fri/Sat/Sun. Continental & Asian food.' },
  { name: 'Shanghai Salsa', area: 'Zoo Tiniali', tags: ['live-music'],
    rating: null, costForTwo: null,
    highlight: 'Mexican-styled pub, live bands on weekends, karaoke. Known for a lively dancing crowd.' },
  ...
  { name: 'Ascend Resto Lounge & Bar', area: 'Christian Basti, Nilakshi Plaza', tags: ['live-music'],
    rating: 4.4, costForTwo: null,
    highlight: 'Live music, great ambience. Konkan/Asian cuisine.' },

  // ----- Clubbing / DJ -----
  { name: 'NYX Lounge and Deck', area: 'Khanapara, above Poddar Car World', tags: ['clubbing'],
    rating: null, costForTwo: null,
    highlight: "Self-described Guwahati's #1 night club. Celebrity DJs, theme nights, big screens for sports." },
  { name: 'Roycee', area: 'Bhangagarh, Exotica Garden', tags: ['clubbing'],
    rating: 4.2, costForTwo: null,
    highlight: 'Full bar, DJ, live sports screening.' },
  { name: 'XS Bar & Lounge', area: 'Tarun Nagar, inside Dynasty Hotel', tags: ['clubbing'],
    rating: 4.1, costForTwo: null,
    highlight: 'Stylish, vibrant music scene, on the pricier side.' },
  { name: 'The Locals', area: 'Khanapara/Retrotown', tags: ['clubbing'],
    rating: null, costForTwo: null,
    highlight: 'DJ-driven nightlife spot.' },
  { name: 'The Vibe House', area: 'Khanapara/Six Mile, Jaya Nagar', tags: ['clubbing'],
    rating: null, costForTwo: null,
    highlight: 'Live band + DJ sets.' },
  { name: 'Nuts and Brew', area: 'Dispur, above Forever 21 (Novotel GS Road)', tags: ['clubbing', 'rooftop', 'lounge-bar'],
    rating: 4.8, costForTwo: 2500,
    highlight: 'Rooftop craft-beer microbrewery with DJ and live music.' },
  { name: 'Abacus Brewing Co & Kitchen', area: 'Khanapara, Hotel Palacio, GS Road', tags: ['clubbing', 'live-music'],
    rating: 4.6, costForTwo: null,
    highlight: 'Craft brewery; reviewers call the live music the best in the city.' },
  ...
  { name: 'Levitate Rooftop Restaurant', area: 'Khanapara, opposite Vivanta by Taj', tags: ['rooftop', 'lounge-bar'],
    rating: 4.8, costForTwo: null,
    highlight: 'Live music, panoramic views over Khanapara.' },
  { name: 'Olive Garden Rooftop Restro Cum Bar', area: 'Ganeshguri', tags: ['rooftop', 'lounge-bar'],
    rating: null, costForTwo: null,
    highlight: 'Live music evenings, eclectic Indian/Italian/Mexican menu. Mixed reviews on pricing.' },
  { name: 'Elevate Bar & Bistro', area: 'Bhangagarh', tags: ['rooftop', 'lounge-bar'],
    rating: null, costForTwo: null,
    highlight: 'Lower-confidence pick — mixed/negative reviews reported (limited drink stock, dull ambience on some visits).', lowConfidence: true },
  { name: 'The Root Barrel', area: 'Zoo Tiniali, Exotica Greens (7th floor)', tags: ['rooftop', 'lounge-bar'],
    rating: null, costForTwo: null,
    highlight: 'Rooftop craft-beer bar with panoramic city views. Mixed feedback on service speed.' },
  { name: 'Terra Mayaa', area: 'Tarun Nagar, Anil Plaza-II', tags: ['rooftop', 'lounge-bar'],
    rating: 4.1, costForTwo: null,
    highlight: 'Open-air rooftop deck, panoramic views, full bar.' },
  ...
  { name: 'FTV Bar & Lounge', area: 'Christian Basti', tags: ['lounge-bar'],
    rating: 5, costForTwo: null,
    highlight: '"Trendy and relaxing" outdoor terrace (TripAdvisor favorite).' },
  { name: 'Reign - Bar & Lounge', area: 'Radisson Blu Hotel, Maligaon', tags: ['lounge-bar'],
    rating: 4.5, costForTwo: null,
    highlight: 'Upscale, quiet/peaceful, pool-side seating. Best for a classy, calm drink rather than a party.' },
  { name: '188 Downtown', area: 'Dispur, inside Novotel', tags: ['lounge-bar'],
    rating: null, costForTwo: null,
    highlight: 'Upscale multi-cuisine dining + bar, praised for its music. Ranked #7 in Guwahati.' },
  { name: 'Trafik Lounge Bar & Restaurant', area: 'Silpukhuri', tags: ['lounge-bar'],
    rating: null, costForTwo: null,
    highlight: 'Lower-confidence pick — mixed/mediocre reviews, budget-friendly.', lowConfidence: true },
  { name: 'Beer Cafe', area: 'Times Square Mall, Sreenagar', tags: ['lounge-bar', 'live-music'],
    rating: 4.8, costForTwo: null,
    highlight: 'Wide beer selection, live music, award-winning (Guwahati Food Awards 2024).' },
